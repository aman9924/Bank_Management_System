        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    String cardFormat = cardno.substring(0,4)+"-"+cardno.substring(4,8)+"-"+cardno.substring(8,12)+"-"+cardno.substring(12);
                    Conn c1 = new Conn();
                    ...
                    JOptionPane.showMessageDialog(null, "Card Number: " + cardFormat + "\n Pin:"+ pin);
